...
public class LiteProgressBar extends JProgressBar implements Transparent {
     ...
     *
     * @param transparentComponent
     * @param t transparency
     */
    public static void setHoverTransparency(TransparentComponent transparentComponent, float t) {
        if (t > 1F || t < 0F) {
            throw new IllegalArgumentException("Value out of range");
        }
        transparentComponent.hoverTransparency = t;
    }
	...
	public void setHoverTransparency(float t) {
		setHoverTransparency(transparency, t);
	}
}
