...
public final class GameUpdater extends SpoutcraftDirectories {
	...
	// TODO move to UpdateThread
    public static void setDownloadListener(UpdateThread updateThread, DownloadListener listener) {
        ((UpdateThread.DownloadListenerWrapper) updateThread.listener).setDownloadListener(listener);
    }
	...
	public void setDownloadListener(DownloadListener listener) {
		...
		setDownloadListener(updateThread, listener);
	}
	...
	public void runGame() {
		StartupParameters.runGame(Launcher.getGameLauncher(), user, minecraftSession, downloadTicket);
	}
}
